    ...
    <div class="jumbotron">
        ...
        %>
            ...
            <% if(quiz.getQuizIndex() != quiz.getQuizQuestions().size()){ %>
                ...
                <button type="radio" class="btn btn-primary mg col-lg-5" name="answer" value="c"><%=quizQuestionAnswers.get(i)%></button>
                <button type="radio" class="btn btn-success mg col-lg-5" name="answer" value="i"><%=quizQuestionInc1Answers.get(i)%></button>
                <button type="radio" class="btn btn-danger mg col-lg-5"  name="answer" value="i"><%=quizQuestionInc2Answers.get(i)%></button>
                <button type="radio" class="btn btn-warning mg col-lg-5" name="answer" value="i"><%=quizQuestionInc3Answers.get(i)%></button>
