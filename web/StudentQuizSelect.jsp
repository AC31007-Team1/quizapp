...
<body>
    ...
    <div class="jumbotron">
        ...
        <div class=""><h2></h2></div>
                ...
                %>
            <form role="form" class="fix"  action="ProceedToQuizStart" method="post">
                    <h3 class='display-4'><%=quizList.get(i)%></h3>
                    <button type="submit"  action="ProceedToQuizStart" style="cursor: pointer;" name="quiz" value="<%=quizIdList.get(i)%>"
